...
func stubGitHubRepairWorkflowAttach(t *testing.T) *[]string {
	...
	calls := []string{}
	attachGitHubPRRepairWorkflow = func(_ string, _ beads.Store, _ *config.City, _ config.Rig, monitor config.GitHubPRMonitor, _ beads.Bead, _ githubmonitor.Result) error {
