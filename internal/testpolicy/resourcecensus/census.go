...
var bootstrapPolicy = Ledger{
	...
	Medium: []MediumOwner{
		...
		},
		{
			...
			Resources:       []Resource{ResourceSubprocess},
			OwnerBead:       "ga-csg1lu.1",
			Invariant:       "unattributed-squatter false-positive regression proof is a checked Medium owner",
			ResourceOwner:   "the sleep(60) subprocess is confined to TestCreateSessionAllowsWorkDirWhenLiveProcessIsUnattributedSquatter, which proves the guard against real /proc process data rather than a hand-shaped fake LiveState (ga-thkwp5 Failure 2, PR #4735)",
			MigrationTarget: "P0.4b",
			Expires:         "2026-10-01",
		},
	},
